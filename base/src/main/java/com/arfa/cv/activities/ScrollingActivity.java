package com.arfa.cv.activities;
...
import com.arfa.cv.fragments.myEducation;
import com.google.android.material.appbar.CollapsingToolbarLayout;
import com.google.android.material.tabs.TabLayout;
import com.rhexgomez.typer.roboto.TyperRoboto;
import com.arfa.cv.adapters.ViewPagerAdapter;
import com.arfa.cv.fragments.AboutFragment;
import com.arfa.cv.fragments.ProfessionFragment;
...
public class ScrollingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(R.drawable.cvdp).into(profileImage);
        mViewPagerAdapter.addFragment(AboutFragment.newInstance(), "About");
        mViewPagerAdapter.addFragment(myEducation.newInstance(), "Education");
